...
from trending_winning.backtest.portfolio_models import (
    PORTFOLIO_COLUMNS as PORTFOLIO_COLUMNS,
    PortfolioCandidateSet as PortfolioCandidateSet,
...
from trending_winning.backtest.portfolio_equity import (
    build_portfolio_equity_curve_from_normalized as _compute_portfolio_equity_curve_from_normalized,
)
...
def _build_portfolio_equity_curve_from_normalized(
    ...
    """兼容旧内部导入；实际逐 K 盯市实现位于 portfolio_equity 模块。"""
    return _compute_portfolio_equity_curve_from_normalized(normalized, trades, initial_equity)
