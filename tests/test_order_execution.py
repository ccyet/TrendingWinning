...
def test_order_execution_trailing_take_profit_waits_for_completed_profit_bar(side: str) -> None:
    if side == "long":
        bars = _bars(
            [
                {"open": 10.0, "high": 10.2, "low": 9.8, "close": 10.0},
                {"open": 10.0, "high": 10.8, "low": 9.4, "close": 10.1},
            ]
        )
        stop_price = 9.5
        target_price = 12.0
        ...
        bars = _bars(
            [
                {"open": 10.0, "high": 10.2, "low": 9.8, "close": 10.0},
                {"open": 10.0, "high": 10.6, "low": 9.2, "close": 9.9},
            ]
        )
        stop_price = 10.5
        target_price = 8.0
...
def test_order_execution_trailing_take_profit_uses_previous_completed_bar_level() -> None:
    bars = _bars(
        [
            {"open": 10.0, "high": 10.2, "low": 9.8, "close": 10.0},
            {"open": 10.0, "high": 10.2, "low": 9.9, "close": 10.1},
            {"open": 10.5, "high": 10.6, "low": 10.5, "close": 10.55},
            {"open": 10.7, "high": 11.2, "low": 10.25, "close": 10.4},
        ]
    )
...
@pytest.mark.parametrize(
    ...
    [
        ("long", "conservative", "trailing_take_profit", 10.67),
        ("long", "optimistic", "take_profit", 11.5),
        ("short", "conservative", "trailing_take_profit", 9.27),
        ("short", "optimistic", "take_profit", 8.5),
    ],
)
def test_intrabar_exit_policy_resolves_target_and_trailing_hit_in_same_bar(
    side: str,
    policy: str,
    expected_reason: str,
    expected_exit: float,
    ...
    if side == "long":
        bars = _bars(
            [
                ...
                {"open": 10.0, "high": 10.2, "low": 9.9, "close": 10.1},
                {"open": 10.8, "high": 11.0, "low": 10.7, "close": 10.9},
                {"open": 11.0, "high": 11.6, "low": 10.6, "close": 11.2},
            ]
        )
        stop_price = 9.5
        target_price = 11.5
        ...
        bars = _bars(
            [
                ...
                {"open": 10.0, "high": 10.1, "low": 9.8, "close": 9.9},
                {"open": 9.2, "high": 9.3, "low": 9.0, "close": 9.1},
                {"open": 9.1, "high": 9.35, "low": 8.4, "close": 8.8},
            ]
        )
        stop_price = 10.5
        target_price = 8.5
