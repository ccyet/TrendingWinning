...
组合回测同样支持 `--trailing-take-profit-activation-pct / --trailing-take-profit-drawdown-pct`；退出原因会在 `trades.csv` 和 `exit_reason_stats.csv` 中显示为 `trailing_take_profit`。
